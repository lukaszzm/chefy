...
export const BadgeCheckbox = React.forwardRef<HTMLInputElement, BadgeCheckboxProps>(({ id, label, ...props }, ref) => {
  return (
    <>
      <input className="peer hidden" id={id} ref={ref} type="checkbox" {...props} />
      <Label
