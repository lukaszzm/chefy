...
export const Sidebar = () => {
  return (
    <aside className="sm:inset-y fixed bottom-0 z-20 flex w-full  items-center border-t bg-popover sm:left-0 sm:h-full sm:w-auto sm:flex-col sm:space-y-6 sm:border-r sm:border-t-0 sm:p-2  lg:p-4">
