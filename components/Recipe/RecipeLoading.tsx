...
export const RecipeLoading = () => {
  return (
    <Card>
      <div className="w-72 m-auto h-72 sm:h-[17rem]  bg-gray-200 animate-pulse rounded-md"></div>
      ...
      <div className="my-2 mb-11 w-full h-16 bg-gray-200 animate-pulse rounded-md"></div>
      <Buttons disabled />
    </Card>
  );
};
