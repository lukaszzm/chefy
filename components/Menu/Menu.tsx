...
export const Menu = () => {
  ...
  return (
    <>
      <div className="fixed overflow-auto overflow-x-hidden inset-x-0 bottom-0 w-full bg-gray-50 border-t flex z-10 sm:h-full sm:px-2 sm:w-32 md:w-64 sm:flex-col sm:inset-auto sm:bottom-auto justify-between sm:justify-start items-center shadow-xl">
